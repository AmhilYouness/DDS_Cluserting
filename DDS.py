  ...
  def play(self):
    ...
    for dict_key,data in self.df_dict.items():
      if dict_key != 0 :
        ...
        self.dict_clients_types[dict_key] = {'nbrClusters' : self.MyClusters.Nbr_clusters , 'dict_all' : self.MyClusters.dict_all , 'centroids' : self.MyClusters.centroids , 'list_durations' : self.MyClusters.list_durations , 'list_commandes' : self.MyClusters.list_commandes }
